...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Inspect the indoor spatial model, plan routes, validate connectivity and simulate disruptions in one 3D workspace.",
      },
      { property: "og:title", content: "Model workspace — INFER" },
      { property: "og:description", content: "A single 3D workspace for indoor model inspection, routing and scenarios." },
    ],
  }),
  ...
  return (
    <div className="relative min-h-0 flex-1">
      <InferModelViewport
        ...
        highlightedRoute={workMode === "navigate" ? route : route}
      ...
      >
        <div className="viewport-dark contents">
          {!animation.playing && workMode !== "layers" && workMode !== "navigate" && <FloorSelector />}
